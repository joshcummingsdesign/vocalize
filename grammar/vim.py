    ...
    def _make_vim_series_rule(self) -> Rule:
        ...
        return SeriesMappingRule(
            ...
            mapping={
                ...
                '[<n>] back': Function(lambda n: self._optional_repeat('b', n)),
                '[<n>] big back': Function(lambda n: self._optional_repeat('B', n)),
    ...
    def _make_vim_rule(self) -> Rule:
        ...
        return MappingRule(
            ...
            mapping={
                ...
                'del <line> from <l> [in] [<char>]': Function(lambda line, l, char: self._line_in_register('d', line, l, char)) + Key('c-o'),
